...
public SortedListPriorityQueue( ) { super( ); }
//Creates an empty priority queue using the given comparator to order keys.
public SortedListPriorityQueue(Comparator<K> comp) { super(comp); }
