...
public class BookStoreClassTwo
{
 ...
 public  BookStoreClassTwo ( int size)
	...
	{
		BufferedReader input = new BufferedReader (new FileReader("/Users/divyabishnoi/Documents/Eclipse2015/LabEleven/inventory.txt"));
...
//      System.out.println( "i  j  maxSubscript");
...
//          printList();
   ...
   {
	 int tempQuantity = quantity[first];
	 String tempList = list[first];
     list[first] = list[second];
     quantity[first] = quantity[second];

     list[second] = tempList;
     quantity[second] = tempQuantity;
   }
